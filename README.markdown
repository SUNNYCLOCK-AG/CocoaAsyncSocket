...
```bash
github "SUNNYCLOCK-AG/CocoaAsyncSocket" "master"
```
...
```swift
dependencies: [
    .package(url: "https://github.com/SUNNYCLOCK-AG/CocoaAsyncSocket", from: "7.6.4")
]
```
...
For those new(ish) to networking, it's recommended you **[read the wiki](https://github.com/SUNNYCLOCK-AG/CocoaAsyncSocket/wiki)**.<br/>_Sockets might not work exactly like you think they do..._
...
[![donation-bitcoin](https://bitpay.com/img/donate-sm.png)](https://onename.com/SUNNYCLOCK-AG)
